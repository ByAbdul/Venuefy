...
const Footer = () => {
  return (
    <div className='footer'>
        <div className="footer-content">
          ...
          <div className="footer-content-center">
            ...
            <li><Link to='about' smooth={true} offset={-150} duration={500}>
              About Us</Link></li>
            <li><Link to='facilit' smooth={true} offset={-200} duration={500}>
              Facilities</Link></li>
        ...
        © Copyright 2024 Grand Auditorium, Hosangadi  .All rights reserved. Website Designed and Developed by Venuefy
        </p>
